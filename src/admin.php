...
function autoship_admin_reports_tabs_content( $id ){
  ...
  'survey_results'          => urlencode($site_id) . '/reports/retention-reports?tokenBearerAuth=' . urlencode($token_auth) );
...
function autoship_admin_retain_and_grow_tabs_content( $id ){
  ...
  $reports = array(
    ...
    'dunning'             => urlencode($site_id) . '/retain-and-grow/dunning?tokenBearerAuth=' . urlencode($token_auth),
